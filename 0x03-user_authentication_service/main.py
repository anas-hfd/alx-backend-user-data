...
def register_user(email: str, password: str) -> None:
    ...
    expected_msg = {"email": email, "message": "user created"}
...
def log_in(email: str, password: str) -> str:
    ...
    expected_msg = {"email": email, "message": "logged in"}
...
def profile_logged(session_id: str) -> None:
    """Test for validating profile request after login"""
    cookies = {
        "session_id": session_id
    }
    response = requests.get(f'{BASE_URL}/profile', cookies=cookies)

    expected_msg = {"email": EMAIL}
...
def log_out(session_id: str) -> None:
    ...
    expected_msg = {"message": "Bienvenue"}
...
def reset_password_token(email: str) -> str:
    ...
    expected_msg = {"email": email, "reset_token": reset_token}
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    ...
    expected_msg = {"email": email, "message": "Password updated"}
